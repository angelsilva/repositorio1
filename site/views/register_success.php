				...
				<div class="margen-banner">
					<div id="banner" class="scroller">
						<div class="scrollable">
							<div class="items">
								<div class="item">
									Welcome to ColabEx, {nombres} {apellidos}! <br /><br />
									An email was sent to your email address <br /> <br />
									<a href="#"> {email} </a><br /> <br />
									To help you complete the registration process you must activate your account by clicking the link that is sent in the body of this email
								</div>
							</div>
						</div>
						<div class="navi"></div>
